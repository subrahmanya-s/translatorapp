...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Japanese"};
    String[] toLanguages = {"To","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Japanese"};
        ...
        translateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(fromLanguageCode == toLanguageCode){
                    Toast.makeText(MainActivity.this,"You are translating it to the same language",Toast.LENGTH_SHORT).show();
                }
                if(sourceEdt.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(MainActivity.this, "Please enter the language to translate to", Toast.LENGTH_SHORT).show();
                }else{
